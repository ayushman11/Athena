!(function (e, t) {
      ...
      function (e) {
        ...
        return (
          i !== T &&
            ...
            (d.getElementsByClassName = J.test(T.getElementsByClassName)),
            ...
            (a = []),
            (m = []),
            (d.qsa = J.test(T.querySelectorAll)) &&
              (ce(function (e) {
      ...
      return (
        ...
        ue(function (e, t, n, i) {
          var r,
            ...
            h = g ? (v || (e ? d : u || m) ? [] : t) : f;
          if ((g && g(f, h, n, i), m))
            for (r = Ee(h, l), m(r, [], n, i), o = r.length; o--; )
              (s = r[o]) && (h[l[o]] = !(f[l[o]] = s));
          if (e) {
            if (v || d) {
              if (v) {
  ...
  function we(e, t, n, i, r) {
    ...
    for (f.textContent = "", d = 0; (o = h[d++]); )
      if (i && -1 < C.inArray(o, i)) r && r.push(o);
        ...
        ((u = oe(o)), (s = me(f.appendChild(o), "script")), u && ve(s), n)
      )
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && D(t, "input") && Ne(t, "click", Ce),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && D(t, "input") && Ne(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function qe(n, i, r, o) {
    ...
    var e,
      ...
      d = i[0],
      p = y(d);
    if (p || (1 < f && "string" == typeof d && !v.checkClone && Oe.test(d)))
